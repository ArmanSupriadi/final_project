<?php
include '../koneksi.php';
$alls = mysqli_query($conn, "SELECT movies.judul, movies.cover_image, genres.genre_name FROM movies JOIN genres ON movies.genre_id = genres.genre_id");
                                    ...
                                    <div class="card mb-4 product-wap rounded-5" style="background-color: black; color: white; position: relative;">
                                        ...
                                        <div class="card-body" style="position: absolute; bottom: 0; width: 100%; background: rgba(0, 0, 0, 0);">
                                            ...
                                            <div class="card-boy rounded-5 mt-2">
                                                ...
                                                <span class="btn btn-hover iq-button ml-2">
